...
export default function User(props){
    ...
    return (
        <div key={props.data.socketId} className='flex flex-row p-2 px-4 justify-between hover:bg-slate-400 hover:cursor-pointer hover:text-white' onClick={handleOnClick}>
